...
public class EnvScalarConstructor extends Constructor {
    ...
    public EnvScalarConstructor() {
        this.yamlConstructors.put(EnvScalarConstructor.ENV_TAG, new EnvScalarConstructor.ConstructEnv((EnvScalarConstructor.SyntheticClass_1) null));
    }
    ...
    private class ConstructEnv extends AbstractConstruct {
        ...
        ConstructEnv(EnvScalarConstructor.SyntheticClass_1 x1) {
            this();
        }
    }
}
