...
public class SpeedMine extends Module {
    ...
    Value mode = (new ValueBuilder()).withDescriptor("Mode").withValue("Packet").withModes(new String[] { "Packet", "Instant", "InstantBypass"}).withAction((set) -> {
        this.autoBreak.setActive(((String) set.getValue()).contains("Instant"));
        this.delay.setActive(((String) set.getValue()).contains("Instant"));
        this.autoBreakGhostSwitch.setActive(((String) set.getValue()).contains("Instant"));
        this.stopCount.setActive(((String) set.getValue()).contains("Instant"));
        this.animateFill.setActive(((String) set.getValue()).equals("Packet"));
        this.animateOutline.setActive(((String) set.getValue()).equals("Packet"));
    }).register(this);
