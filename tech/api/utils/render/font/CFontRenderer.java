...
public class CFontRenderer extends CFont {
    ...
    private void setupBoldItalicIDs() {
        this.texBold = this.setupTexture(this.font.deriveFont(1), true, true, this.boldChars);
        this.texItalic = this.setupTexture(this.font.deriveFont(2), true, true, this.italicChars);
        this.texItalicBold = this.setupTexture(this.font.deriveFont(3), true, true, this.boldItalicChars);
    }
